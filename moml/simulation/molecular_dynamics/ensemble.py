...
class EnsembleStrategy:
    ...
    def run(self, system: System, positions: unit.Quantity, output_dir: Path) -> Dict:
...
def run_ensemble(system: System,
                positions: unit.Quantity,
                output_dir: Path,
                strategy: str = "npt",
                **kwargs) -> Dict:
    """Run ensemble simulation with specified strategy."""
    config = kwargs.pop("config", MDConfig())
    ...
    return ensemble.run(system, positions, output_dir) 